...
INSERT INTO `computers` VALUES (1,'laptop','twój','stary','xD','abc',123.00,12);
...
INSERT INTO `ordered_computers` VALUES (1,1,1,5),(2,1,1,5),(7,1,1,14),(36,1,1,41);
...
INSERT INTO `orders` VALUES (3,23,'open','2019-01-24'),(4,23,'open','2019-01-24'),(5,23,'open','2019-01-24'),(11,20,'open','2019-01-24'),(14,20,'open','2019-01-24'),(26,20,'open','2019-01-24'),(41,20,'open','2019-01-24');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `add_ordered_computer` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `add_ordered_computer`(IN id_computer int)
BEGIN
	INSERT INTO ordered_computers VALUES(
	NULL,
	id_computer,
	1,
	@ordnr
...
-- Dump completed on 2019-01-24 21:34:39
