...
INSERT INTO `clients` VALUES (19,'client','client','client','telephone','client','client','client'),(46,'z1','z1','z1','123123123','z1','z1','z1'),(47,'z2','z2','z2','123123123','z2','z2','z2'),(48,'z3','z3','z3','123123123','z3','z3','z3');
...
INSERT INTO `computers` VALUES (1,'laptop','twój','stary','xD','abc',123.00,4),(2,'laptop','as','as','as','as',223.00,10),(3,'laptop','gsgdg','sggs','gsgsgsdg','sgs',123.00,0),(4,'laptop','ada','ada','ad','adad',213.00,2),(5,'laptop','ad','ad','ad','ad',226.00,4),(6,'laptop','cnc','cncn','cnnc','ncncn',12.00,2);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`admin`@`%`*/ /*!50003 TRIGGER `afterUpdateComputersAddOne` AFTER UPDATE ON `computers` FOR EACH ROW BEGIN
  ...
  if(old.ammount<new.ammount AND nll)
  THEN
	INSERT INTO bought_logs
    VALUES(
    NULL,
...
INSERT INTO `ordered_computers` VALUES (1,1,1,5),(2,1,1,5),(7,1,1,14),(36,1,1,41),(119,2,2,111),(120,1,1,111),(126,3,1,118),(127,4,1,118);
...
INSERT INTO `orders` VALUES (3,23,'finished','2019-01-24'),(4,23,'open','2019-01-24'),(5,23,'finished','2019-01-24'),(11,20,'open','2019-01-24'),(14,20,'open','2019-01-24'),(26,20,'open','2019-01-24'),(41,20,'open','2019-01-24'),(111,20,'finished','2019-01-26'),(118,47,'finished','2019-01-27');
...
INSERT INTO `users` VALUES (1,'admin','admin','admin'),(20,'loginnn','hasło','client'),(46,'z1','z1','client'),(47,'z2','z2','client'),(48,'z4','z4','client');
...
-- Dump completed on 2019-01-27  2:44:24
